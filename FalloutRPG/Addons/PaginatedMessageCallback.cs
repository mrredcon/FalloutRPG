// Taken from: https://github.com/PassiveModding/Discord.Addons.Interactive
...
namespace Discord.Addons.Interactive
{
    ...
    /// </summary>
    public class CustomPaginatedMessageCallback : IReactionCallback
    {
        /// <summary>
        /// The run mode.
        /// </summary>
        ...
        /// The criterion.
        /// </param>
        public CustomPaginatedMessageCallback(InteractiveService interactive,
        ...
        /// The <see cref="Task"/>.
        /// </returns>
        public async Task DisplayDMAsync(ReactionList reactionList)
        {
            var embed = BuildEmbed();
            var message = await Context.User.SendMessageAsync(pager.Content, embed: embed).ConfigureAwait(false);
            Message = message;
            Interactive.AddReactionCallback(message, this);
